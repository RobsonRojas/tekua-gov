  ...
  const handlePhotoChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files[0]) {
      ...
      if (file.size > 5242880) {
        setMessage({ type: 'error', text: 'O tamanho da foto n√£o deve exceder 5MB.' });
        return;
      }
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  ...
                  {isEditing ? (
                    <TextField
                      ...
                      placeholder="email, CPF, CNPJ ou chave aleatÛria"
                    />
                  ) : (
                    <Typography variant="body1" fontWeight={500}>
                ...
                <Grid size={{ xs: 12, sm: 6 }}>
                  ...
                  {isEditing ? (
                    <TextField
                      ...
                      placeholder="Conta Corrente, PoupanÁa, etc."
                    />
                  ) : (
                    <Typography variant="body1" fontWeight={500}>
