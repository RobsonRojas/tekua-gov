# Guia Completo do Sistema Tekuá para Iniciantes

Bem-vindo ao Portal Tekuá! Este manual foi criado para ser o seu companheiro passo a passo na utilização do nosso sistema. Aqui, detalhamos cada pedacinho do portal para que você, mesmo sem muita experiência com tecnologia, consiga navegar, participar e aproveitar tudo o que a nossa comunidade digital tem a oferecer.
...
Para usar o sistema, você terá o seu próprio espaço (Perfil), que guarda suas preferências e seu histórico.

### Entrando no Sistema (Login)
1. Ao abrir o portal, você verá uma tela inicial pedindo seu **E-mail** e **Senha**.
...
- **Mudar o Idioma:** Escolher entre Português e Inglês, dependendo do que for mais confortável para você.
...
## 3. O Mural de Avisos (Fique Informado)

Assim que você entra no sistema, a primeira tela que você vê é o seu painel principal (Dashboard). Nela, existe o **Mural de Avisos**.

- **Para que serve?** É como o quadro de recados físico de uma associação. É lá que os administradores colocam os comunicados urgentes, notícias importantes e lembretes de encontros.
- **Como usar:** Basta rolar a tela para baixo para ler os resumos. Se um aviso for muito longo, clique em "Ler mais" ou no título do aviso para abrir o texto completo.

---

## 4. Conhecendo a Comunidade

O portal tem um espaço dedicado para mostrar quem são as pessoas que formam a nossa rede.
...
A Tekuá é baseada na decisão em conjunto. O módulo de Governança é onde a mágica democrática acontece.

### Como Votar e Participar
1. No menu principal, clique no botão **"Governança"**.
...
## 6. Transparência e Acesso a Documentos

Não é preciso pedir para ninguém quando você quiser ler uma regra da associação. Tudo está na palma da sua mão.
- **Como acessar:** Vá até a aba **"Documentação"** ou **"Arquivos"** no menu.
- **O que tem lá:** Uma biblioteca digital completa. Você encontrará pastas divididas por temas, contendo:
  - Os Estatutos Oficiais.
  - Atas (os resumos oficiais) das assembleias passadas.
...
A Tekuá tem um sistema próprio para incentivar a colaboração entre os membros, baseado em uma "moeda virtual" chamada **Surreal**. Ela não é comprada com dinheiro, ela é conquistada através do trabalho em prol da comunidade!
...
## 8. Compartilhamento de Equipamentos
...
## 9. Assistentes Inteligentes de IA (Sempre Prontos para Ajudar)

Se você tem dificuldade de achar alguma informação, o portal possui "Agentes de Inteligência Artificial" (robôs amigáveis) que funcionam como assistentes pessoais.
...
## 10. Notificações: Como o Sistema Te Avisa

Para você não ter que ficar abrindo o site todo dia só para ver se tem algo novo, o Portal Tekuá usa **Notificações**.
- Elas funcionam como os avisos do WhatsApp ou do Facebook. Se abrir uma votação importante ou se alguém te transferir Surreais, você receberá um pequeno aviso na tela do seu computador ou celular.

---

## 11. Como Instalar o Aplicativo no Celular

O Portal Tekuá não está na lojinha da Apple (App Store) nem na do Google (Play Store). Mas ele pode ser instalado direto pelo seu navegador! É mais leve, rápido e não ocupa quase nada de memória.

**Se estiver usando um celular Android (Chrome):**
1. Abra o site do Portal Tekuá no navegador do celular (Chrome).
2. Clique nos três pontinhos no canto superior direito.
3. Procure pela opção **"Adicionar à Tela Inicial"** ou **"Instalar Aplicativo"**.
4. Confirme. O ícone da Tekuá vai aparecer junto com seus outros aplicativos, pronto para ser usado.

**Se estiver usando um iPhone (Safari):**
1. Abra o site do Portal Tekuá no Safari.
2. Clique no ícone de "Compartilhar" (um quadradinho com uma seta para cima, na parte de baixo da tela).
3. Role um pouco para baixo e clique em **"Adicionar à Tela de Início"**.
4. Confirme. Pronto!

---

**Dica Final de Ouro:** A tecnologia não morde! A melhor forma de aprender a usar o portal é clicando nos botões, abrindo os menus e explorando sem medo. O sistema foi desenhado para ser seguro, então é muito difícil você "quebrar" alguma coisa apenas navegando. Se tiver dúvidas, pergunte ao Assistente Virtual ou a um administrador!
