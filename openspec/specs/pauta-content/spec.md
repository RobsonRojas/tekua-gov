# pauta-content Specification

## Purpose
Editor de texto rico (WYSIWYG) para criação e edição do conteúdo de pautas/votações, com suporte a React 19 e sanitização HTML.
