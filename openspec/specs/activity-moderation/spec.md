# activity-moderation Specification

## Purpose
Definir as permissões e interface para a moderação de atividades na plataforma, garantindo que apenas membros autorizados possam aprovar ou rejeitar tarefas e que a interface seja devidamente localizada.
...
- **THEN** the "Approve" button SHALL display "Aprovar" and the "Reject" button SHALL display "Rejeitar" (ou "Reprovar").
