# task-priority-configuration Specification

## Purpose
Define a configuração da Matriz de Eisenhower (Urgência vs Importância) para a classificação de tarefas, permitindo que administradores personalizem a cadência de notificações e lembretes baseados na prioridade.
