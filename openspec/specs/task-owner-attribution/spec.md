...
O sistema DEVE permitir que apenas usuários com perfis de `admin` ou `transversal_council` visualizem e utilizem o seletor de executor nas interfaces de criação e edição de demandas.
...
O seletor de executor DEVE carregar e listar todos os perfis ativos da plataforma para seleção por parte dos administradores.
...
Ao salvar uma demanda com um executor atribuído, o sistema DEVE registrar o `worker_id` na tabela de atividades e garantir que a tarefa seja vinculada corretamente a esse usuário.
