...
- [ ] 1.1 Acessar [vercel.com](https://vercel.com) e autenticar com a conta do GitHub onde o repositório `tekua-gov` está hospedado.
- [ ] 1.2 Importar o repositório `tekua-gov` no painel da Vercel.
- [ ] 1.3 Selecionar o framework preset "Vite" na tela de configuração.
